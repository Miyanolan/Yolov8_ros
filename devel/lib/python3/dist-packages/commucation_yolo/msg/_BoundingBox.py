...
"""autogenerated by genpy from commucation_yolo/BoundingBox.msg. Do not edit."""
import codecs
import sys
...
class BoundingBox(genpy.Message):
  _md5sum = "de89cc60d817b2f1c432be0fd081bedb"
  _type = "commucation_yolo/BoundingBox"
...
string frame_id
"""
  __slots__ = ['probability','xmin','ymin','xmax','ymax','Class','mask']
  _slot_types = ['float64','int64','int64','int64','int64','string','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       probability,xmin,ymin,xmax,ymax,Class,mask
