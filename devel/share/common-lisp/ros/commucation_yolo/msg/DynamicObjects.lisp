...
;//! \htmlinclude DynamicObjects.msg.html

(cl:defclass <DynamicObjects> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass DynamicObjects (<DynamicObjects>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <DynamicObjects>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'DynamicObjects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commucation_yolo-msg:<DynamicObjects> is deprecated: use commucation_yolo-msg:DynamicObjects instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <DynamicObjects>))
...
(cl:defmethod image_header-val ((m <DynamicObjects>))
...
(cl:defmethod mask-val ((m <DynamicObjects>))
...
(cl:defmethod bounding_boxes-val ((m <DynamicObjects>))
  ...
  (bounding_boxes m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DynamicObjects>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DynamicObjects>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DynamicObjects>))
  "Converts a ROS message object to a list"
  (cl:list 'DynamicObjects
